...
<div class="container">
    ...
    <div id="main-tournament" class="container bg-gray regforms">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/make_pumce">
		...
		<input type="hidden" name="type" value="pumce">
            ...
            <hr>
                            ...
                            <div class="form-group">
                                <label class="col-md-12 text-center" for="town2">Місто</label>
                                <div class="col-md-12 ">
            ...
            <div class="form-group" style="text-align:center;">
                ...
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="number" min="0" id="court_count" name="court_count">
                </div>
            </div>
            <div class="form-group" style="text-align:center;">
