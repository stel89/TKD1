...
<div class="container">
    ...
    <div id="main-tournament" class="container bg-gray regforms">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/competition/{{$competition->id}}/change_competition">
		<input type="hidden" name="_token" value="{{ csrf_token() }}">
		<input type="hidden" name="type" value="competition">
		<input type="hidden" name="country" value="Украина">
            <div class="form-group">
                <label class="col-md-12 text-center"><h3>Редагування змагання</h3></label>
                <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <hr>
            <div class="form-group">
                <label class="col-md-12" for="logo">Лого <span class="red">(не обов'зково)</span></label>
                <div class="col-md-12">
                    <input class="form-control" type="file" id="logo" name="logo" style="text-align:right;">
					<label class="col-md-12" for="logo">Залиште пустим якщо не треба змінювати</label>
                </div>
            </div>
            <hr><div style="width:100%; text-align:center;">
                <div class="form-group">
                <label class="col-md-12">Вікові групи</label>
            ...
            <div class="form-group">
                <label class="col-md-12 ">Рівень змагань</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <select class="form-control" id="tournament_level" name="tournament_level" required="">
                        <option value="Місцевий">Місцевий</option>
                        <option value="Регіональний / Відкритий">Регіональний / Відкритий</option>
                        <option value="Національний">Національний</option>
                        <option value="Міжнародний">Міжнародний</option>
                    </select>
                </div>
            </div>
                  <div class="form-group">
                <label class="col-md-12">Код доступу <span class="red">(не обов'язково)</span></label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="text" id="code" name="code">
					<label class="col-md-12">Залиште пустим якщо не треба змінювати</label>
                </div>
                 </div>
            <div class="form-group">
                <label class="col-md-12">Кількість доянгів</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="number" min="1" id="court_count" name="court_count" required="" value="{{$competition->court_count}}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-12">Ліміт участників:</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="number" min="1" id="limited" name="limited" required="" value="{{$competition->limited}}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-12">Пароль для суддів:</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="text" id="judge_password" name="judge_password">
					<label class="col-md-12">Залиште пустим якщо не треба змінювати</label>
                </div>
            </div>
...
<div class="en">
    <title>Creating competition</title>
        <hr>
@if(Session::has('message'))
	<ul class="list-group" style="width:50%; margin-left:auto; margin-right:auto; margin-top:10px; text-align:center;">
  <li class="list-group-item list-group-item-success">{{Session::get('message')}}</li>
...
<div class="container">
    ...
    <div id="main-tournament" class="container bg-gray regforms">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/competition/{id}/change_competition">
		<input type="hidden" name="_token" value="{{ csrf_token() }}">
		<input type="hidden" name="type" value="competition">
			<input type="hidden" name="country" value="Украина">
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <input class="form-control" id="date_to" name="date_to" type="date" required="" value="{{$competition->date_from}}">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-md-12 text-center">Competition programm:</label>
                <div class="col-md-12">
                    <textarea rows="8" class="form-control" name="program" required="">{{$competition->programm}}</textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <hr>
            <div class="form-group">
                <label class="col-md-12" for="logo">Logo <span class="red"> (not necessary)</span></label>
                <div class="col-md-12">
                    <input class="form-control" type="file" id="logo" name="logo" style="text-align:right;">
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-md-12 ">Tournament level</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <select class="form-control" id="tournament_level" name="tournament_level" required="">
                        <option value="Місцевий">Local</option>
                        <option value="Регіональний / Відкритий">Regional / Open</option>
                        <option value="Національний">National</option>
                        <option value="Міжнародний">International</option>
                    </select>
                </div>
            </div>
                  <div class="form-group">
                <label class="col-md-12">Access code <span class="red"> (not necessary and leave empty if no need to change)</span></label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="text" id="code" name="code">
                </div>
                 </div>
            <div class="form-group">
                <label class="col-md-12">Court count</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="number" min="1" id="court_count" name="court_count" required="" value="{{$competition->court_count}}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-12">Participants limit:</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="number" min="1" id="limited" name="limited" required="" value="{{$competition->limited}}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-12">Password for judges (Leave empty if no need to change)</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="text" id="judge_password" name="judge_password">
                </div>
            </div>
                <div class="form-group regforms" style="margin-left:45%">
                    <div class="col-sm-2">
                        <button id="regComplete" type="submit" name="toursubmit" class="btn btn-lg btn-info ">Create</button>
                    </div>
                </div></div>
        </form>
    </div>
