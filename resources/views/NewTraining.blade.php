...
@section('content')
<div class="ua">
  <title>Створення тренувального збору</title>
...
<div class="container">
    ...
    <div id="main-tournament" class="container bg-gray regforms">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/make_training">
		...
		<input type="hidden" name="country" value="Украина">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-6">
                        <label class="col-md-12" for="date_from">Дата з </label>
                        <div class="col-md-12">
            ...
            <hr>
            <div class="form-group">
                <label class="col-md-12" for="logo">Лого <span class="red">(не обов'язково)</span></label>
                <div class="col-md-12">
...
<div class="en">
  <title>Creating training camp</title>
