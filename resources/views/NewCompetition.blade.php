...
@section('content')
<div class="ua">
    <title>Створення змагання</title>
...
<div class="container">
    ...
    <div id="main-tournament" class="container bg-gray regforms">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/make_competition">
		...
		<input type="hidden" name="country" value="Украина">
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input class="form-control" id="tourname" maxlength="120" name="tourname" type="text" autofocus="" required="">
                </div>
            </div>
            <div class="form-group">
                <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="number" min="1" id="court_count" name="court_count" required="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-12">Ліміт участників:</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="number" min="1" id="limited" name="limited" required="">
                </div>
            </div>
            <div class="form-group">
...
<!--
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                    <select class="form-control" id="country2" name="country2" required="" value="">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6" style="margin-left:25%;">
                  ...
                  <div class="form-group">
                <label class="col-md-12">Access code <span class="red"> (not necessary)</span></label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="text" id="code" name="code">
                </div>
                 </div>
            ...
            <div class="form-group">
                <label class="col-md-12">Password for judges:</label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="text" id="judge_password" name="judge_password" required="">
                </div>
            </div>
