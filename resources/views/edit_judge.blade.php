...
<title>Редагування профілю {{Auth::user()->surname}} {{Auth::user()->name}}</title>
 <div class="row">
        <div class="text-center text-uppercase" style="margin-left:-20px">
	 ...
	 <h3 class="gray text-center">Реєстраційні данні</h3>
						...
						<input type="hidden" name="country2" value="Ukraine">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                    <input class="form-control" type="email" id="email2" name="email2" placeholder="E-mail" autofocus="" required="" value="{{$profile->email}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="password" id="passw2" name="passw2" placeholder="Залиште пустим якщо не бажаете змінювати">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="text" id="name2" name="name2" value="{{$profile->name}}" placeholder="Ім&#39;я" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="text" id="surname2" name="surname2" value="{{$profile->surname}}" placeholder="Прізвище" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="text" id="patronymic2" name="patronymic2" value="{{$profile->patronymic}}" placeholder="По-батькові" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                    <select class="form-control" id="cat" name="cat" required="" value="{{$profile->cat}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                    <select class="form-control" id="sex2" name="sex2" required="" value="{{$profile->sex}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
									...
									<label class="col-sm-8 control-label" for="avatar2" style="margin-left:60px;">Залиште пустим якщо не бажаете змінювати</label>
                                </div>
                            </div>
							
                            <div class="form-group">
                                <div class="col-sm-11"  style="text-align:center !important;">
                                    <button id="regComplete" type="submit" class="btn btn-success btn-lg pull-right" style="float:none !important; margin-left:15%;">Змінити</button>
                                </div>
                            </div>
    ...
    <title>{{Auth::user()->surname}} {{Auth::user()->name}}</title>
	 ...
	 <h3 class="gray text-center">Registration information</h3>
						...
						<input type="hidden" name="country2" value="Ukraine">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="passw2">New Password</label>
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="password" id="passw2" name="passw2" placeholder="Leave empty if change is no need">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input required="" class="form-control" type="file" id="avatar1" name="avatar1">
									<label class="col-sm-8 control-label" for="avatar2">Leave empty if change is no need</label>
                                </div>
                            </div>
							
                            <div class="form-group">
                                <div class="col-sm-11"  style="text-align:center !important;">
                                    <button id="regComplete" type="submit" class="btn btn-success btn-lg pull-right" style="float:none !important; margin-left:15%;">Change</button>
                                </div>
                            </div>
