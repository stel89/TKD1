...
@section('content')
<div class="ua">
 <title>Змінити данні змагання по Пумсе</title>
...
@endif
@if (count($errors) > 0)
 <ul class="list-group ua" style="width:300px; margin-left:auto; margin-right:auto;">
...
<div class="container">
    ...
    <div id="main-tournament" class="container bg-gray regforms">
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="/competition/{{$competition->id}}/change_pumce">
	    <input type="hidden" name="_token" value="{{ csrf_token() }}">
		<input type="hidden" name="type" value="pumce">
            ...
            <div class="form-group" style="text-align:center;">
                <label class="col-md-12">Код доступу <span class="red">(не обов'язково, залиште пустим якщо не потрібо змінювати)</span></label>
                <div class="col-md-6" style="margin-left:25%;">
            ...
            <div class="form-group" style="text-align:center;">
                ...
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="number" min="0" id="court_count" name="court_count" value="{{$competition->court_count}}">
                </div>
            </div>
            <div class="form-group" style="text-align:center;">
                <label class="col-md-12">Пароль для суддів (залиште пустим якщо не потрібно змінювати)</label>
                <div class="col-md-6" style="margin-left:25%;">
            ...
            <div class="form-group regforms" style="margin-left:45%">
                <div class="col-sm-2">
                    <button id="regComplete" type="submit" name="toursubmit" class="btn btn-lg btn-info ">Створити</button>
                </div>
            </div></div>
        </form>
    </div>
...
@endif
@if (count($errors) > 0)
 <ul class="list-group en" style="width:300px; margin-left:auto; margin-right:auto;">
@foreach ($errors->all() as $error)
<li class="list-group-item list-group-item-danger">{{ $error }}</li>
@endforeach
</ul>
...
<div class="container">
    ...
    <div id="main-tournament" class="container bg-gray regforms">
		...
		<input type="hidden" name="country" value="Украина">
            ...
            <div class="form-group">
                <label class="col-md-12 text-center">Competition program</label>
                <div class="col-md-12">
                    <textarea rows="8" class="form-control" name="program" required="">{{$competition->programm}}</textarea>
                </div>
            </div>
			...
			<div style="text-align:center;">
             ...
             <div class="form-group">
                <label class="col-md-12">Access code <span class="red"> (not necessary leave empty if no need to change)</span></label>
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="text" id="code" name="code">
                </div>
                 </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6" style="margin-left:25%;">
                    <input class="form-control" type="text" id="judge_password" name="judge_password" required="">
                </div>
            </div>
                <div class="form-group regforms" style="margin-left:45%">
                    <div class="col-sm-2">
