...
<title>Редагування профілю {{Auth::user()->surname}} {{Auth::user()->name}}</title>
 <div class="row">
        <div class="text-center text-uppercase" style="margin-left:-15px;">
	 ...
	 <h3 class="gray text-center">Реєстраційні данні</h3>
						...
						<input type="hidden" name="country1" value="Ukraine">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                    <input class="form-control" type="email" autocomplete="off" id="email1" name="email1" placeholder="E-mail" autofocus="" required="" value="{{$profile->email}}">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="passw">Новий пароль</label>
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="password" autocomplete="off" id="passw1" name="passw1" value="" placeholder="Залиште пустим якщо не бажаете змінювати">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" id="name1" name="name1" placeholder="Ім&#39;я" required="" value="{{$profile->name}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="text" id="surname1" name="surname1" value="{{$profile->surname}}" placeholder="Прізвище" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="text" id="patronymic1" name="patronymic1" value="{{$profile->patronymic}}" placeholder="По-батькові" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9  8">
                                    <input class="form-control" list="org1" name="org1" required="" value="{{$profile->org}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                    <select class="form-control" id="sex1" name="sex1" required="" value="{{$profile->sex}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 ">
                                    <input class="form-control" type="text" name="fst1" required="" value="{{$profile->fst}}">
                                </div>
                            </div>

                            <br>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="avatar1">Аватар</label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="file" id="avatar1" name="avatar1" placeholder="Залиште пустим якщо не бажаете змінювати">
									<label class="col-sm-8 control-label" for="avatar1" style="margin-left:60px;">Залиште пустим якщо не бажаете змінювати</label>
                                </div>
                            </div>				
							

                            <div class="form-group" style="position:relative; left:-275px;">
                                <div class="col-sm-11">
    ...
    <title>{{Auth::user()->surname}} {{Auth::user()->name}}</title>
	 ...
	 <h3 class="gray text-center">Registration information</h3>
						...
						<input type="hidden" name="country2" value="Ukraine">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="passw">New Password</label>
                                <div class="col-sm-9  ">
                                    <input class="form-control" type="password" autocomplete="off" id="passw1" name="passw1" value="" placeholder="Leave empty if change is no need">
                                </div>
                            </div>
                            ...
                            <br>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="avatar1">Avatar</label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="file" id="avatar1" name="avatar1" placeholder="Leave empty if change is no need">
									<label class="col-sm-8 control-label" for="avatar1" style="margin-left:60px;">Leave empty if change is no need</label>
                                </div>
                            </div>				
